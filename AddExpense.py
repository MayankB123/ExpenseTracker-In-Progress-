...
from sql import add_expense

class AddExpenseFrame(tk.Toplevel):
    def __init__(self, master, dashboard_frame, user):
        super().__init__(master)
        self.master = master
        self.dashboard_frame = dashboard_frame
        self.user = user
        self.title("Expense Entry")

        # Name Entry
        self.name_label = tk.Label(self, text="Name of expense:")
        self.name_label.grid(row=0, column=0, padx=10, pady=5)
        self.name_entry = tk.Entry(self)
        self.name_entry.grid(row=0, column=1, padx=10, pady=5)

        self.date_label = tk.Label(self, text="Date of expense:")
        ...
        self.category_dropdown = ttk.Combobox(self, textvariable=self.category_var,
                                              values=["Essentials", "Entertainment", "Transport", "Miscellaneous"])
    ...
    def submit(self):
        ...
        add_expense(self.user, name, date, category, amount)
        self.destroy()